...
public class Hammazon implements Servicio{
	 ...
	 */
	public void hammazonNormal(Cliente c){
		plan = new HammazonNormal(c);
	}
	 ...
	 */
	public void hammazonPremium(Cliente c){
		plan = new HammazonPremium(c);
	}
	...
	public void agregar(Cliente c){
		...
		System.out.println(c.getNombre() + " Te damos la bienvenida a Hammazon n.n");
	}
	...
	public void eliminar(Cliente c){
		System.out.println(c.getNombre() + " lamentamos que tenga que dejar Hammazon u.u ");
		clientes.remove(c);
	}
